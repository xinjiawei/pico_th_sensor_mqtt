...
#ifndef PICO_EXAMPLES_BMP280_I2C_H
#define PICO_EXAMPLES_BMP280_I2C_H

#endif //PICO_EXAMPLES_BMP280_I2C_H
...
struct bmp280Reading{
    float pressure_kpa;//湿度
    float temp_c;//温度-摄氏度的
};
void bmp280_init();
